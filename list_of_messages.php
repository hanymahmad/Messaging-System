    ...
    <body>
        <div class="content">
            ...
            <?php
                ...
                $list = mysqli_query($db, 'select title, sender, message, timestamp from message where receiver="'.$username.'"');
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo htmlentities($dnn['message'], ENT_QUOTES, 'UTF-8'); ?></td>
